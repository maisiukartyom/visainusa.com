...
<div className="abouteb3-first-block">
            <div className="first-block-abouteb3">
               <h2 className="h2-abouteb3">ABOUT EB3</h2>
               <p className="text-abouteb3">Are you seeking information on how to become a legal immigrant in the United States?
                 Congratulations, you've come to the right place. Here, you can find all the information about the EB3 visa category and schedule a consultation with our highly experienced team, who have successfully navigated the immigration process and obtained permanent resident cards.</p>
                 <p  className="text-abouteb3">Our team possesses extensive knowledge and experience in the EB3 visa category and can provide you with the support and guidance you need. Contact us today to schedule a consultation and take the first step toward realizing your dream of becoming a legal immigrant in the U.S</p>
                 <p className="read-start"> Now, let's briefly explain what the EB3 visa is. </p>
...
<div className="abouteb3-second-block">
  <div className="info-second-block">
  <div className="abouteb3-video">
  <iframe  src="https://www.youtube.com/embed/ncUPeCJYWco?si=s6BcjDDfo8abD0mP" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen className="youtube-level1"></iframe>
...
To qualify for the EB3 visa, applicants must fall into one of three subcategories: professionals, skilled workers, or unskilled workers. Professionals have at least a bachelor's degree in a specific field. Skilled workers have at least 2 years of experience, education, or training in their field, meeting job requirements specified in the labor certification. Unskilled workers must demonstrate the ability to perform unskilled labor, which requires less than 2 years of training or experience and is not of a temporary or seasonal nature. The unskilled subcategory is particularly attractive as it doesn't require a specific level of education, previous job experience, or English proficiency. In other words, almost anyone can be eligible for the EB3 unskilled visa category.  ... "
             ...
             Each EB3 case is unique, and, in general, the entire process may take between 2 to 5 years, depending on factors such as visa retrogression, audits, or requests for evidence. Patience is crucial throughout the process. Becoming a legal immigrant in the U.S. is a complex journey, and we highly recommend seeking assistance from experienced professionals who can guide you through the entire process.
             " />
  </div>
  </div>
</div>
