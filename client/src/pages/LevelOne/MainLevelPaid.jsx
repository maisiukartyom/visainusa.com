...
export const MainLevelPaid = () => {
    return(
        <div className="text-leveltwo">
          ...
          {/* <p className='important'>Important to read</p>
          <img className='arrow-imp' src='images/important.png' alt='arrow' width={40} height={20}/> */}
          ...
          <TextBlockone className="text-levelOne"  title=" The duration of the EB-3 unskilled visa process can vary significantly,
            ...
            In the graphic chart below, you can observe the entire process for adjustment of status applicants under the best-case scenario, excluding delays such as audits, requests for evidence, and retrogression. The first step in your EB3 journey is the Labor Certification, which typically takes 8 to 12 months for approval.
          ...
          <TextBlockone className="text-levelOne"  title=" First option is to research EB3 agencies, consult immigration experts, compare services and costs, look for client testimonials, and evaluate the transparency of each agency.
            ...
            You'll receive a template for an email and presentation that might help you find a U.S. employer independently. Moreover, you will receive a curated list of immigration attorneys who can assist your sponsor with the PERM process and help draft, review, and file your immigration forms.
            Additionally, you'll be provided with step-by-step instructions for self-filing immigration forms, with the option to consult with a lawyer for a final check before submission to USCIS. Level 3 also includes a 60-minute personal consultation with one of our experts."/>
                          </div> 
                          </div>
                          </div>
                          <div>
          ...
          <TextBlockone className="text-levelOne"  title=" Disclaimer: 'Visa in US' LLC is not a law firm and does not provide legal advice.
            ...
            advice please get in touch with an     ..." description="immigration attorney. Visitor status (B1/B2) provides three pathways to apply for EB3 unskilled:
            1. Adjustment of status (AOS): If you are in the U.S. on B status, completing the entire adjustment of status (AOS) from within the U.S. might not be possible. B status allows you to stay in the U.S. for up to 6 months, while AOS may take 2-4 years. You can attempt to extend B status for an additional 6 months, but it may still not be sufficient. You can apply for EB3 unskilled while you have valid B status and change your B status to another non-immigrant status, such as J or F, which allows you to maintain your lawful status as long as you continue enrolling in SEVIS-approved schools. There is no time limit on how long you can keep student status. If, for any reason, your change of B status to F status is denied, you can apply for EB3 and must depart the U.S. before your B status expires. You can then re-enter the U.S. in valid B status for AOS filing after your Labor Certification (LC) is approved and the priority date is current. Holding F status allows you to legally work only up to 20 hours on the school's campus. Under difficult life situations, you can request USCIS to obtain an employment authorization document (EAD/work permit) to work outside of the school campus. As an alternative option to earn money under F status, you can create a legal entity. However, you need to hire someone with a valid EAD to work in your company, as you can't be involved in the daily routine business activities. This means you can receive income only as a beneficiary. Having F status, you can apply for political asylum if you have a case for it. The pending asylum status provides the legal right to work in the U.S. while you wait for the immigration interview under your political case. It is important to emphasize that you must have F status and pending asylum status simultaneously to undergo the immigration interview under EB3 unskilled inside the U.S. Otherwise, having only pending asylum status, you most likely need to leave the U.S. to undergo the immigration interview for the EB3 unskilled visa category.2. Start with consular processing (CP) and transition to adjustment of status (AOS). If you are not in the U.S. but have a B visa, you can initiate the EB3 process from outside the U.S. and conclude it inside the U.S. The process involves the following steps: Labor Certification (LC): Your U.S. employer must obtain a labor certification from the U.S. Department of Labor. This involves demonstrating that there are no qualified U.S. workers available for the position and that hiring you will not negatively impact the wages and working conditions of similarly employed U.S. workers. Form I-140 Petition: After the labor certification is approved, your U.S. employer files Form I-140, Immigrant Petition for Alien Worker, on your behalf with U.S. Citizenship and Immigration Services (USCIS). Visa Bulletin and Priority Date: Monitor the Visa Bulletin to check when your priority date becomes current. Due to annual numerical limits on immigrant visas, there may be a waiting period (retrogression). Travel to the U.S. on B Status: Once your priority date is current, you can plan a temporary trip to the U.S. on your B visa. Ensure you have evidence of your intent to return to your home country and maintain ties to your home country. Please note that, in general, an approved I-140 alone does not mean you have immigrant intent. That means if you are outside the U.S. and going through consular processing, you may continue to travel to the U.S. if you have a valid temporary visa (like a B1/B2) after the I-140 is approved. However, you will need to stop traveling to the U.S. using the temporary visa once the National Visa Center (NVC) has collected all of your documents and sent your case to the U.S. consulate for final processing and the consular interview. Once you receive notice from the NVC that your case has been sent to the consulate, you should not attempt to enter the U.S. until you have the immigrant visa in hand after your consular interview. Adjustment of Status (AOS): If your intent changes, and you decide to adjust your status after entering the U.S., you can file for Adjustment of Status (AOS). It is generally advised to wait at least 60 days from your last entry on a B visa before filing for AOS. Remain in the U.S. for Processing: Once you file for AOS, you must remain in the U.S. until Advanced Parole (travel parole) is issued. During this period, you are not permitted to work until your Employment Authorization Document (EAD) is issued. The approval time for Advance Parole and Employment Authorization Document is about 5 - 7 months. It means that after your entry into the U.S., you will not have the right to travel internationally and work for up to 7 months while waiting for the approval of Advance Parole and Employment Authorization Document.3. Start with Adjustment of Status (AOS) and conclude with Consular Processing (CP). If you initially apply for EB3 unskilled through Adjustment of Status (AOS) while residing inside the U.S., and later decide to leave the U.S. for any reason, you can file Form I-824, Application for Action on an Approved Application or Petition, to request consular processing. However, this transfer is likely to add an additional lag of 5 to 10 months to the timeframe. Switching from AOS to Consular Processing is only possible after filing Form I-140 with USCIS. During the Labor Certification stage, you can leave the U.S. without filing the I-824 form. Only after the Labor Certification is approved do you need to choose between Adjustment of Status or Consular Processing. This pathway may also help address unauthorized work in the U.S. If you worked without authorization for over 180 days since your last entry into the U.S. but maintained valid status (i.e., your I-94 has not expired or you have a timely filed extension), you will need to undergo Consular Processing. This means that once your Labor Certification (LC) and I-140 immigration petition are approved, you will need to leave the U.S. to apply for the green card from outside the U.S. Undergoing the immigration interview outside the U.S. under EB3 unskilled visa can help you obtain the green card, as U.S. embassy officers will not consider your unauthorized work in the U.S. as a violation. 

          F status (student)
          In terms of success rate, having F status is considered one of the best options for applying for EB3 unskilled. There is no time limit on how long you can maintain student status, as long as you continue enrolling in SEVIS-approved schools. You can choose English language courses, community college, or a university—whatever you can afford. Your family members will have F2 status and can reside in the U.S. legally. Students typically face the first challenge of a lack of income. Working without an Employment Authorization Document significantly decreases your chances of obtaining a permanent resident card/green card in the U.S. Any job performed without authorization is considered unauthorized, regardless of whether taxes were paid. Furthermore, receiving payment in cash for any job within the U.S. or performing tasks remotely, including but not limited to teaching, accounting, or coding, for a company located outside of the U.S. without the proper authorization is also deemed unauthorized work. Volunteering is allowed, but taking on positions typically held by paid employees is generally prohibited. Students have authorization to make financial investments for capital generation, such as investing in stocks or bonds and being involved passively as an investor, without participating in productive work for the company. However, actively engaging in the day-to-day operations of a business or participating in active Forex trading is not allowed. Holding F status allows you to work legally for up to 20 hours on the school's campus. In difficult life situations, you can try to request an Employment Authorization Document (EAD/work permit) from USCIS to work outside of the school campus. As an alternative option to earn money under F status, you can create or buy a legal entity. However, you need to hire someone with a valid Employment Authorization Document (EAD) to work in your company since you cannot be involved in the daily routine business activities. This means you can only receive income as a beneficiary. It is crucial to maintain F status in the U.S. at least until Form I-140 is approved, and Form I-485 is filed. To be on the safe side, it is better to continue keeping your F status until you have your green card in hand. The crucial point is that if, for any reason, you are denied during the immigration interview under EB3 unskilled (due to a failed medical exam, unauthorized work, unlawful status, or your sponsor's fault), you will not become illegal since you have valid F status.In some cases, with F status, you can apply for political asylum if you have a case to do so. The pending asylum status provides the legal right to work in the U.S. while you wait for the immigration interview under your political case. It is important to emphasize that you must have both F status and pending asylum status simultaneously to undergo the immigration interview under EB3 unskilled within the U.S. Otherwise, if you have only pending asylum status, you most likely need to leave the U.S. to undergo the immigration interview for the EB3 unskilled visa category. Another advantage of having F status is that you can start working for your sponsor in an unskilled job based on your Employment Authorization Document (EAD) under the OPT program while your EAD under EB3 is not yet approved. This way, you can fulfill the 12-month commitment sooner. The disadvantage of F status is the absence of a work permit to work outside of your school's campus."/>
                          </div> 
                          </div>
                          </div>
                          {/* <div>
