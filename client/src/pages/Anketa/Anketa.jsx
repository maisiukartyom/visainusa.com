            ...
            <div className="container-center">
                ...
                <form>
                    <div className="one">
                        ...
                        <div className="mt">
                            <input className="test"  type="radio" name="question1" id="answerOne"/>Yes
                            <input className="test"  type="radio" name="question1" />No
                        </div>
                    </div>
                    ...
                    <div className="two">
                        ...
                        <div className="mt">
                            <input className="test"  type="radio" name="question2" id="answerTwo"/>Yes
                            <input className="test"  type="radio" name="question2" />No
                        </div>
                    </div>
                    ...
                    <div className="three">
                        ...
                        <div className="mt">
                            <input className="test"  type="radio" name="question3" id="answerThree"/>Yes
                            <input className="test"  type="radio" name="question3" />No
                        </div>
                    </div>
                    ...
                    <div className="four">
                        ...
                        <div className="mt">
                            <input className="test"  type="radio" name="question4" id="answerFour"/>Yes
                            <input className="test"  type="radio" name="question4" />No
                        </div>
                    </div>
                    ...
                    <div className="five">
                        ...
                        <div className="mt">
                            <input className="test"  type="radio" name="question5" id="answerFive"/>Yes
                            <input className="test"  type="radio" name="question5" />No
                        </div>
                    </div>
                    ...
                    <div className="six">
                        ...
                        <div className="mt">
                            <input className="test"  type="radio" name="question6" id="answerSix"/>Yes
                            <input className="test"  type="radio" name="question6" />No
                        </div>
                    </div>
                    ...
                    <div className="seven">
                        ...
                        <div className="mt">
                            <input className="test"  type="radio" name="question7" id="answerSeven"/>Yes
                            <input className="test"  type="radio" name="question7" />No
                        </div>
                    </div>
                    ...
                    <div className="eight">
                        ...
                        <div className="mt">
                            <input className="test"  type="radio" name="question8" id="answerEight"/>Yes
                            <input className="test"  type="radio" name="question8" />No
                        </div>
                    </div>
                    ...
                    <div className="nine">
                        ...
                        <div className="mt">
                            <input className="test"  type="radio" name="question9" id="answerNine"/>Yes
                            <input className="test"  type="radio" name="question9" />No
                        </div>
                    </div>
                    ...
                    <div className="ten">
                        ...
                        <div className="mt">
                            <input className="test"  type="radio" name="question10" id="answerTen"/>Yes
                            <input className="test"  type="radio" name="question10" />No
                        </div>
                    </div>
                    ...
                    <div className="eleven">
                        ...
                        <div className="mt">
                            <input className="test"  type="radio" name="question11" id="answerEleven"/>Yes
                            <input className="test"  type="radio" name="question11" />No
                        </div>
                    </div>
                    ...
                    <div className="twelve">
                        ...
                        <div className="mt">
                            <input className="test"  type="radio" name="question12" id="answerTwelve"/>Yes
                            <input className="test"  type="radio" name="question12" />No
                        </div>
                    </div>
                    ...
                    <div className="thirteen">
                        ...
                        <div className="mt">
                            <input className="test"  type="radio" name="question13" id="answerThirteen"/>Yes
                            <input className="test"  type="radio" name="question13 " />No
                        </div>
                    </div>
                </form>
            </div>
