        ...
        <div className="body">
            ...
            <div className="logo-center"><Link to="/"><img src="/images/logo.png" alt="logo"  width={70} height={94}/></Link></div>
                    <div className="one" value={answers[0]} onChange={e => handleAnswerChange(0, e.target.value)}>
                        ...
                        <div className="mt">
                            <label><input  className="test input-anketa "  type="radio" name="question1" id="answerOne" value="yes"/>Yes</label>
                            <label><input className="test input-anketa"  type="radio" name="question1" value="no"/>No</label>
                        </div>
                        </div>
                        ...
                        <div className="mt">
                            <label><input className="test input-anketa"  type="radio" name="question2" id="answerTwo" value="yes"/>Yes</label>
                            <label><input className="test input-anketa"  type="radio" name="question2" value="no"/>No</label>
                        </div>
                    </div>
                    ...
                    <div className="three" value={answers[2]} onChange={e => handleAnswerChange(2, e.target.value)}> 
                        ...
                        <div className="mt">
                            <label><input className="tes input-anketat"  type="radio" name="question3" id="answerThree" value="yes"/>Yes</label>
                            <label><input className="test input-anketa"  type="radio" name="question3" value="no"/>No</label>
                        </div>
                    </div>
                    ...
                    <div className="four" value={answers[3]} onChange={e => handleAnswerChange(3, e.target.value)}>
                        ...
                        <div className="mt">
                            <label><input className="test input-anketa"  type="radio" name="question4" id="answerFour" value="yes"/>Yes</label>
                            <label><input className="test input-anketa"  type="radio" name="question4" value="no"/>No</label>
                        </div>
                    </div>
                    ...
                    <div className="five" value={answers[4]} onChange={e => handleAnswerChange(4, e.target.value)}>
                        ...
                        <div className="mt">
                            <label><input className="test input-anketa"  type="radio" name="question5" id="answerFive" value="yes"/>Yes</label>
                            <label><input className="test input-anketa"  type="radio" name="question5" value="no"/>No</label>
                        </div>
                    </div>
                    ...
                    <div className="six" value={answers[5]} onChange={e => handleAnswerChange(5, e.target.value)}>
                        ...
                        <div className="mt">
                            <label><input className="test input-anketa"  type="radio" name="question6" id="answerSix" value="yes"/>Yes</label>
                            <label><input className="test input-anketa"  type="radio" name="question6" value="no"/>No</label>
                        </div>
                    </div>
                    ...
                    <div className="seven" value={answers[6]} onChange={e => handleAnswerChange(6, e.target.value)}>
                        ...
                        <div className="mt">
                            <label><input className="test input-anketa"  type="radio" name="question7" id="answerSeven" value="yes"/>Yes</label>
                            <label><input className="test input-anketa"  type="radio" name="question7" value="no"/>No</label>
                        </div>
                    </div>
                    ...
                    <div className="eight" value={answers[7]} onChange={e => handleAnswerChange(7, e.target.value)}>
                        ...
                        <div className="mt">
                            <label><input className="test input-anketa"  type="radio" name="question8" id="answerEight" value="yes"/>Yes</label>
                            <label><input className="test input-anketa"  type="radio" name="question8" value="no"/>No</label>
                        </div>
                    </div>
                    ...
                    <div className="nine" value={answers[8]} onChange={e => handleAnswerChange(8, e.target.value)}>
                        ...
                        <div className="mt">
                            <label><input className="test input-anketa"  type="radio" name="question9" id="answerNine" value="yes"/>Yes</label>
                            <label><input className="test input-anketa"  type="radio" name="question9" value="no"/>No</label>
                        </div>
                    </div>
                    ...
                    <div className="ten"  value={answers[9]} onChange={e => handleAnswerChange(9, e.target.value)}>
                        ...
                        <div className="mt">
                            <label><input className="test input-anketa"  type="radio" name="question10" id="answerTen" value="yes"/>Yes</label>
                            <label><input className="test input-anketa"  type="radio" name="question10" value="no"/>No</label>
                        </div>
                    </div>
                    ...
                    <div className="eleven" value={answers[10]} onChange={e => handleAnswerChange(10, e.target.value)}>
                        ...
                        <div className="mt">
                            <label><input className="test input-anketa"  type="radio" name="question11" id="answerEleven" value="yes"/>Yes</label>
                            <label><input className="test input-anketa"  type="radio" name="question11" value="no"/>No</label>
                        </div>
                    </div>
                    ...
                    <div className="twelve" value={answers[11]} onChange={e => handleAnswerChange(11, e.target.value)}>
                        ...
                        <div className="mt">
                            <label><input className="test input-anketa"  type="radio" name="question12"  value="yes"/>Yes</label>
                            <label><input className="test input-anketa"  type="radio" name="question12" id="answerTwelve" value="no"/>No</label>
                        </div>
                    </div>
                    ...
                    <div className="thirteen" value={answers[12]} onChange={e => handleAnswerChange(12, e.target.value)}>
                        ...
                        <div className="mt">
                            <label><input className="test input-anketa"  type="radio" name="question13"  value="yes"/>Yes</label>
                            <label><input className="test input-anketa"  type="radio" name="question13" id="answerThirteen" value="no"/>No</label>
                        </div>
                    </div>
                    ...
                    <div className="thirteen" value={answers[13]} onChange={e => handleAnswerChange(13, e.target.value)}>
                        ...
                        <div className="mt">
                            <label><input className="test input-anketa"  type="radio" name="question14"  value="yes"/>Yes</label>
                            <label><input className="test input-anketa"  type="radio" name="question14" id="answerFourteen" value="no"/>No</label>
                        </div>
                    </div>
                    ...
                    <div className="thirteen" value={answers[14]} onChange={e => handleAnswerChange(14, e.target.value)}>
                        ...
                        <div className="mt">
                            <label><input className="test input-anketa"  type="radio" name="question15"  value="yes"/>Yes</label>
                            <label><input className="test input-anketa"  type="radio" name="question15" id="answerFifteen" value="no"/>No</label>
                        </div>
                    </div>
