...
export const MainLevelTwoPaid = () => {
    ...
    return(
      ...
      <TextBlocktwo className="text-levelTwo" title="Thank you for choosing Level 2! To schedule a call with one of our experts, 
      it's as easy as clicking on the 'Schedule the Call' button below on this page. Choose a time slot that suits you,
